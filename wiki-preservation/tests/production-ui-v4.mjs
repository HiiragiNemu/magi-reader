...
try {
  ...
  await page.waitForSelector('.portal-card.active[data-portal="characters"]', { timeout: 15_000 });
  await page.waitForFunction(() => document.querySelector('#portal-results h2')?.textContent?.includes('魔法少女与人物'), null, { timeout: 15_000 });
  ...
  check(characterState.resultHeading.includes('魔法少女与人物'), `人物结果标题错误：${characterState.resultHeading}`);
